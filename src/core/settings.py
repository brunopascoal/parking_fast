...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Parking Fast",
    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Parking Fast",
    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Parking Fast",
    ...
    "welcome_sign": "Welcome to the Parking Fast",
    # Copyright on the footer
    "copyright": "Brunop LTDA",
    ...
    "icons": {
        ...
        "vehicles.VehicleType": "fa-solid fa-truck-plane",
        "parking.ParkingSpot": "fa-solid fa-parking",
        "parking.ParkingRecord": "fa-solid fa-parking",
